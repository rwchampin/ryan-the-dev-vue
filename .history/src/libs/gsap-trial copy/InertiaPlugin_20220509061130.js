...
class v {
  ...
  add(t, e) {
    t in this._props ||
      ...
      (n = this._props[t] = new m(this.target, t, e, n)))
  }
  remove(t) {
    let e,
      i,
  ...
  static track(t, r, n) {
    ...
    let o,
      ...
      p = l.length
    for (; p--; ) {
      for (o = u(l[p]) || new v(l[p]), s = c.length; s--; )
        o.add(c[s], g[s] || g[0])
      a.push(o)
    }
    return a
...
;(v.getByTarget = u), c() && t.registerPlugin(v)
let w,
  y,
  _,
  x,
  ...
  S = R(103, 114, 101, 101, 110, 115, 111, 99, 107, 46, 99, 111, 109),
  W = (function (t) {
    var e = 'undefined' != typeof window,
      i =
        ...
        -1 !== t.indexOf(R(49, 50, 55, 46, 48, 32, 48, 46, 49)),
      r = [
        S,
        ...
        R(116, 119, 101, 101, 110, 108, 105, 116, 101, 46, 99, 111, 109),
  ...
  q = t => {
    let e,
      i,
      r = {}
    for (e in t) r[e] = I((i = t[e])) && !j(i) ? q(i) : i
    return r
  },
  z = (t, e, i, r, n) => {
    let o,
    ...
    if (I(t)) {
      ...
      if ((n || U) < U && n < Math.sqrt(p)) return t
    } else
      for (; c--; )
        (o = e[c]),
          (s = o - t),
  ...
  D = (t, e, i, r, n, o, s) => {
    ...
    let a,
      l,
      c = t.end
    if (((i = isNaN(i) ? U : i), (r = isNaN(r) ? -U : r), I(e))) {
      if (
        ((a = e.calculated ? e : (B(c) ? c(e, s) : z(e, c, i, r, o)) || e),
        !e.calculated)
      ) {
        for (l in a) e[l] = a[l]
        e.calculated = !0
      ...
      a = a[n]
    } else a = B(c) ? c(e, s) : j(c) ? z(e, c, i, r, o) : parseFloat(c)
    return (
      a > i ? (a = i) : a < r && (a = r),
      {
        max: a,
  ...
  G = (t, e, i) => (isNaN(t[e]) ? i : +t[e]),
  H = (t, e) => (0.05 * e * t) / O,
  J = (t, e, i) => Math.abs(((e - t) * O) / i / 0.05),
  K = {
    resistance: 1,
    checkpoint: 1,
    preventOvershoot: 1,
      ...
      for (n = 0; n < g.length; n++)
        (o = g[n]),
          ...
          s &&
            (C(s.velocity)
              ? (a = s.velocity)
              : ((l = l || E(t)), (a = l && l.isTracking(o) ? l.get(o) : 0)),
            (c = Math.abs(a / G(s, 'resistance', r))),
            (p[o] = parseFloat(i(t, o)) + H(a, c)))
      return p
    }
  },
  X = () => {
...
const Y = {
  ...
  init(t, e, i, r, n) {
    ...
    ;(this.target = t), (this.tween = i), (b = e)
    let s,
      a,
      l,
      c,
      ...
      v = e.duration,
      w = I(v),
      _ = e.preventOvershoot || (w && 0 === v.overshoot),
      k = G(e, 'resistance', T.resistance),
      O = C(v)
        ? v
        : ((t, e, i = 10, r = 0.2, n = 1, o = 0) => {
            if (('string' == typeof t && (t = x(t)[0]), !t)) return 0
            let s,
              a,
              l,
              c,
              ...
              w = e.inertia || e,
              y = N(t).get,
              _ = G(w, 'resistance', T.resistance)
            for (s in ((f = Q(t, w, y, _)), w))
              K[s] ||
                ((a = w[s]),
                I(a) ||
                  ((d = d || E(t)),
                ...
                I(a) &&
                  ...
                  (l = M(r, i, Math.abs(c / G(a, 'resistance', _)))),
                  (g = parseFloat(y(t, s)) || 0),
                  (p = g + H(c, l)),
                  'end' in a &&
                    ((a = D(
                      a,
                  ...
                  u > m && (m = u)),
                l > m && (m = l))
            return m > v && (m = v), m > i ? i : m < r ? r : m
          })(
            t,
            e,
            (w && v.max) || 10,
            (w && v.min) || 0.2,
            w && 'overshoot' in v ? +v.overshoot : _ ? 0 : 1,
            !0,
          )
    for (s in ((e = b), (b = 0), (h = Q(t, e, m, k)), e))
      K[s] ||
        ((a = e[s]),
        B(a) && (a = a(r, t, n)),
        C(a)
        ...
        I(a) &&
          ((u = l + p),
          'end' in a &&
            (a = D(a, h && s in h ? h : u, a.max, a.min, s, e.radius, g)),
          'max' in a && +a.max < u
            ...
            : 'min' in a &&
              ...
              (_ || a.preventOvershoot
                ...
                : (d = a.min - l - p))),
        this._props.push(s),
        (this._pt = new P(this._pt, t, s, l, 0, L, 0, f.set(t, s, this))),
        (this._pt.u = c || 0),
        (this._pt.c1 = p),
        (this._pt.c2 = d))
    return i.duration(O), W
  },
  render(t, e) {
    let i = e._pt
    for (t = k(e.tween._time / e.tween._dur); i; )
      i.set(
        i.t,
        i.p,
        ((r = i.s + i.c1 * t + i.c2 * t * t), Math.round(1e4 * r) / 1e4 + i.u),
        i.d,
        t,
      ),
        (i = i._next)
...
'track,untrack,isTracking,getVelocity,getByTarget'
  .split(',')
  .forEach(t => (Y[t] = v[t])),
  A() && w.registerPlugin(Y)
export default Y
export { Y as InertiaPlugin, v as VelocityTracker }

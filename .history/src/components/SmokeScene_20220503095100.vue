...
let clock, camera, scene, renderer, geometry, material, mesh, text;
...
function init() {
  ...
  const textMaterial = new THREE.MeshLambertMaterial({color: 0x000000, opacity: 1, map: textTexture, transparent: true, blending: THREE.AdditiveBlending})

...
<script setup>
import gsap, { ScrollTrigger, InertiaPlugin, Physics2DPlugin } from '../libs/gsap-bonus/all.js';
import * as THREE from 'three';
import TheLogo from './TheLogo.vue';

gsap.registerPlugin(ScrollTrigger, Physics2DPlugin, InertiaPlugin);
...
function init() {
  ...
  const buildSceneMesh = () => {
    ...
    const textTexture = THREE.ImageUtils.loadTexture('src/assets/logo.png');

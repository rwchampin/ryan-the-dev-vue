<template>
  <canvas ref="particleIntro"></canvas>
</template>
<script>
export default TheParticleIntro;
</script>
<script setup>
...
onMounted(() => {
  ...
  export class TheParticleIntro extends ThreeSceneSetup {
  constructor(container, config) {
    ...
    this.topSpheres = new Spheres(config, [new THREE.Color('#ff3030'), new THREE.Color('#121214')]);
